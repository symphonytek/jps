object frmTC: TfrmTC
  ...
  Caption = 'Scholar'#39's Transfer Certificate'
  ClientHeight = 512
  ClientWidth = 559
  Color = clBtnFace
  ...
  object Query1: TMyQuery
    ...
    SQL.Strings = (
      'SELECT tcdata.admno,tcno,name'
      'FROM tcdata inner join studmast on tcdata.admno=studmast.studid'
      'WHERE  UPPER(CAST('
      'tcdata.admno'
    ...
    object Query1admno: TStringField
      FieldName = 'admno'
      Size = 10
    end
    object Query1tcno: TIntegerField
      FieldName = 'tcno'
    end
