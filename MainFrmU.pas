...
uses
  ...
  ToolWin, ComCtrls, Menus, ImgList, ExtCtrls, System.ImageList;
...
type
  TMainFrm = class(TForm)
    ...
    procedure AdHoccharge1Click(Sender: TObject);
  private
...
uses AboutU, myfuncu, userU, usermgrfrmU, frmCLMastU,
  ...
  frmBounceU, frmDailyAttndU, frmDueDtU, frmAdmitCardOthU, frmSMSSendU,
  frmAdHocU;
...
procedure TMainFrm.AdHoccharge1Click(Sender: TObject);
begin
frmAdHoc.showmodal;
end;
...
procedure TMainFrm.SendSMS1Click(Sender: TObject);
begin
