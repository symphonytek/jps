object frmAdmStudMastXI: TfrmAdmStudMastXI
  Left = 459
  Top = 90
  ...
  object Label15: TLabel
    ...
    Width = 220
    Height = 28
    Caption = ' Student registration XI '
    Color = clHighlight
  ...
  object btnTrasfer: TSpeedButton
    Left = 270
    Top = 447
    Width = 33
    Height = 33
    Caption = '-->'
    OnClick = btnTrasferClick
  end
  object DBNavigator1: TDBNavigator
    ...
    Width = 192
    Height = 33
    DataSource = MyData.adm_studmastXIS
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object DBLookupComboBox1: TDBLookupComboBox
        ...
        Width = 115
        Height = 21
        DataField = 'adm_subcode'
        DataSource = MyData.adm_studmastXIS
        KeyField = 'subcode'
        ListField = 'subcode'
        ListSource = MyData.dsAdmxi_subj
        TabOrder = 11
      end
    ...
    object TabSheet4: TTabSheet
      ...
      object DBGrid1: TDBGrid
        ...
        Margins.Right = 2
        Margins.Bottom = 2
        DataSource = MyData.dsAdmstud_docsXI
        TabOrder = 0
    ...
    object TabSheet5: TTabSheet
      ...
      object DBGrid2: TDBGrid
        ...
        Width = 593
        Height = 297
        DataSource = MyData.dsAdm_finalxi
        TabOrder = 0
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
        ...
        Columns = <
          ...
          item
            ...
            Expanded = False
            FieldName = 'studfname'
            Title.Caption = 'Father'#39's name'
            Visible = True
          end>
      end
    end
  end
  object btnAutoRej: TBitBtn
    Left = 328
    Top = 447
    Width = 75
    Height = 34
